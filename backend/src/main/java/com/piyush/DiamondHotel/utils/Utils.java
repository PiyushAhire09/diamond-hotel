package com.piyush.DiamondHotel.utils;

import com.piyush.DiamondHotel.dto.BookingDTO;
import com.piyush.DiamondHotel.dto.RoomDTO;
...
public class Utils {
    ...
    // Maps Room Entity to RoomDto Wit all room booking
    ...
    // Map Booking Entity to BookingDto with booked room and User who booked Room
    public static BookingDTO mapBookingEntityToBookingDTOPlusBookedRooms(Booking booking, boolean mapUser) {
        ...
        if (booking.getRoom() != null) {        // If the booking has an associated Room
            RoomDTO roomDTO = new RoomDTO();
